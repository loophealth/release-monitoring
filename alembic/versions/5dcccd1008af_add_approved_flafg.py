...
Revision ID: 5dcccd1008af
Revises: 2c692f958531
Create Date: 2024-06-22 13:20:59.167296
...
revision: str = '5dcccd1008af'
down_revision: Union[str, None] = '2c692f958531'
...
def upgrade() -> None:
    ...
    op.drop_table('release_comments')
...
def downgrade() -> None:
    ...
    sa.Column('state', sa.VARCHAR(length=17), nullable=True),
    ...
    op.create_table('release_comments',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('release_action_id', sa.NUMERIC(), nullable=False),
    sa.Column('comment', sa.VARCHAR(), nullable=False),
    sa.Column('commented_by', sa.VARCHAR(), nullable=False),
    sa.Column('created_on', sa.TIMESTAMP(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['release_action_id'], ['release_actions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
